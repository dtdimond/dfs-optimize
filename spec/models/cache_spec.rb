...
describe Cache do
  ...
  describe ".last_updated" do
    it 'returns the last updated time for the player record' do
      ...
      expect(Cache.last_updated(player)).to be_near_to_time cache.cached_time
    end
    ...
    it 'returns the last updated time for the salary record' do
      ...
      expect(Cache.last_updated(salary)).to be_near_to_time cache2.cached_time
    end
    ...
    it 'returns the last updated time for the projection record' do
      ...
      expect(Cache.last_updated(projection)).to be_near_to_time cache1.cached_time
    end
